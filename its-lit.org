...
:LAST_MODIFIED: [2026-03-23 Mon 18:39]
...
- [[#config-directory-for-non-byte-compiled-files][Config directory for non-byte-compiled files]]
  ...
  - [[#editor-utilities-and-core-functionality][Editor utilities and "core" functionality]]
    ...
    - [[#group-buffers-by-project][Group buffers by project]]
      - [[#disabled][Disabled]]
  ...
  - [[#configure-themes][Configure themes]]
    ...
    - [[#nerd-icons][Nerd icons]]
      - [[#disabled-icon-packages][Disabled icon packages]]
    - [[#theme-advice-and-hooks][Theme advice and hooks]]
    - [[#theme-lisp-footer][Theme lisp footer]]
  ...
  - [[#diagramming-modes-and-tools][Diagramming modes and tools]]
    - [[#diagramming-language-modes][Diagramming Language Modes]]
      - [[#disabled-diagramming-tools][Disabled diagramming tools]]
    - [[#unicode-drawing-tools][Unicode Drawing Tools]]
    - [[#diagramming-file-footer][Diagramming File Footer]]
  ...
  - [[#setup-font-lockingel][setup-font-locking.el]]
    - [[#disabled-font-lock-packages][Disabled font lock packages]]
  ...
  - [[#writing-in-emacs][Writing in emacs]]
    ...
    - [[#write-browser-text-from-emacs][Write browser text from Emacs]]
...
:PROPERTIES:
:LAST_MODIFIED: [2026-03-11 Wed 02:48]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
...
:LAST_MODIFIED: [2026-07-05 Sun 03:27]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.90
:END:
...
:PROPERTIES:
:LAST_MODIFIED: [2026-03-23 Mon 18:49]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:CUSTOM_ID: load-custom-file-and-run-after-init-hooks
:END:

#+name: specify customs file
#+begin_src emacs-lisp :noweb yes :comments noweb :tangle init.el 
;;;; =============================== Customs ===============================
...
:PROPERTIES:
:LAST_MODIFIED: [2026-04-19 Sun 14:44]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
...
:PROPERTIES:
:LAST_MODIFIED: [2026-05-30 Sat 07:58]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.60
...
:PROPERTIES:
:LAST_MODIFIED: [2026-06-27 Sat 09:20]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.90
...
:LAST_MODIFIED: [2026-03-23 Mon 18:36]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:END:
#+begin_src emacs-lisp 
...
:LAST_MODIFIED: [2026-01-15 Thu 03:51]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:END:
#+begin_src emacs-lisp 
;;;; ========================== Text snippets ==========================
...
:PROPERTIES:
:LAST_MODIFIED: [2026-03-23 Mon 20:09]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:CUSTOM_ID: group-buffers-by-project
:END:
...
**** Disabled
:PROPERTIES:
:LAST_MODIFIED: [2026-03-23 Mon 19:01]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:CUSTOM_ID: disabled
:END:
#+name: One tab per project
#+begin_src emacs-lisp :tangle no
(use-package otpp
  :after project
  :config (otpp-mode 1)
...
:PROPERTIES:
:LAST_MODIFIED: [2026-06-27 Sat 09:19]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.90
...
:PROPERTIES:
:LAST_MODIFIED: [2026-02-20 Fri 07:16]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:CUSTOM_ID: configure-org-functionality-add-ons
:END:

Strange interaction between =org-link-beautify= and =elpaca= or some other package:
1. ~:hook (elpaca-after-init . org-link-beautify-mode)~ works in that the links
   have the desired icons after them. However org-link-beautify-mode claims to
   be disabled, e.g. running the command =org-link-beautify-mode= in an org buffer
   that's already displaying the icons will say org-link-beautify-mode enabled
   when it should presumably be toggling to disabled.
2. Adding a hook like

     #+begin_example
:config
 (add-hook 'elpaca-after-init-hook #'org-link-beautify-mode) 
  #+end_example

and opening an org file the links don't have the icons but running the command
=org-link-beautify-mode= will say disabled when first called which is what you'd
expect if the hook is working.

In both cases the org buffer doesn't seem to update as you cycle through calls
to =org-link-beautify-mode= so I'm going with the ~:hook~ version where the
functionality works even if the mode is messed up. 
 
:PROPERTIES:
:CUSTOM_ID: configure-org-functionality-add-ons
:LAST_MODIFIED: [2026-02-20 Fri 07:06]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:END:
#+begin_src emacs-lisp 
...
**** org-todoist
:PROPERTIES:
:LAST_MODIFIED: [2026-04-19 Sun 11:23]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
...
:LAST_MODIFIED: [2026-06-18 Thu 16:47]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.90
:END:
...
TODO - fix "org-mem: No files found in ‘org-mem-watch-dirs’, and no org-ids
because Org not loaded". 

What hasn't worked:
- Changing the =setopt= call with =(setq org-mem-watch-dirs '("~/obsidian/org/node/"))=
 under =:init=
- Moving =(setq org-mem-watch-dirs '("~/obsidian/org/node/"))=
 to =:preface=

Related: https://github.com/meedstrom/org-mem/issues/48 (unresolved)
...
:LAST_MODIFIED: [2026-01-26 Mon 19:50]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:END:
#+begin_src emacs-lisp 
;;;; ============================== Python ==============================
...
:LAST_MODIFIED: [2026-07-06 Mon 19:03]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.90
:END:
...
** Configure themes
:PROPERTIES:
:header-args:emacs-lisp: :tangle config/configure-themes.el :comments noweb :eval no
:LAST_MODIFIED: [2026-04-19 Sun 14:53]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:CUSTOM_ID: configure-themes
:END:
...
*** Managing fonts
:PROPERTIES:
:LAST_MODIFIED: [2026-06-17 Wed 09:08]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.90
:CUSTOM_ID: managing-fonts
:END:

TODO Investigate the point size presets. They seem to change the font back to
whatever was last set by calling =menu-set-font= . Changing font with
=fontaine-set-preset= and then using a point-size preset seems to work as intended.
...
:LAST_MODIFIED: [2026-02-12 Thu 18:44]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:END:
...
**** Disabled icon packages
:PROPERTIES:
:LAST_MODIFIED: [2026-02-12 Thu 18:37]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:CUSTOM_ID: disabled-icon-packages
:END:
...
*** Theme advice and hooks
:PROPERTIES:
:LAST_MODIFIED: [2025-08-03 Sun 19:35]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:CUSTOM_ID: theme-advice-and-hooks
:END:
...
*** Theme lisp footer
:PROPERTIES:
:LAST_MODIFIED: [2026-04-19 Sun 14:55]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:CUSTOM_ID: theme-lisp-footer
:END:
...
:LAST_MODIFIED: [2026-02-06 Fri 20:52]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:END:
#+begin_src emacs-lisp :tangle no
...
Note: icon display configuration moved to [[Nerd icons]]
...
:LAST_MODIFIED: [2026-02-06 Fri 20:53]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:END:
#+begin_src emacs-lisp :tangle no
...
** Diagramming modes and tools
:PROPERTIES:
:header-args:emacs-lisp: :tangle config/setup-diagramming.el :comments noweb :eval no
:CUSTOM_ID: diagramming-modes-and-tools
:LAST_MODIFIED: [2026-07-05 Sun 03:25]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.90
:END:

#+name: diagramming header
#+begin_src emacs-lisp :comments no :noweb no
;;; config/setup-diagramming.el --- Diagramming tools configuration -*- lexical-binding: t -*-
#+end_src

*** Diagramming Language Modes
:PROPERTIES:
:CUSTOM_ID: diagramming-language-modes
:LAST_MODIFIED: [2026-07-05 Sun 03:33]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.90
:END:
...
**** Disabled diagramming tools
:PROPERTIES:
:header_args:emacs-lisp: :tangle no :noweb no :comments no
:CUSTOM_ID: disabled-diagramming-tools
:LAST_MODIFIED: [2026-07-05 Sun 03:34]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.90
:END:
...
*** Unicode Drawing Tools
:PROPERTIES:
:CUSTOM_ID: unicode-drawing-tools
:END:
...
*** Diagramming File Footer
:PROPERTIES:
:CUSTOM_ID: diagramming-file-footer
:END:

#+name: diagramming footer
#+begin_src emacs-lisp
;; Local Variables:
;; no-byte-compile: t
;; no-native-compile: t
...
:LAST_MODIFIED: [2026-07-06 Mon 19:19]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.90
:END:
...
:LAST_MODIFIED: [2026-04-19 Sun 15:03]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:END:


TODO: Prune evil config, seems like it has a lot of accumulated cruft. 
...
:LAST_MODIFIED: [2026-04-19 Sun 14:28]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:END:
...
*** Disabled font lock packages
:PROPERTIES:
:LAST_MODIFIED: [2026-04-19 Sun 13:51]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:header_args: :eval no :tangle no :noweb no
:CUSTOM_ID: disabled-font-lock-packages
:END:
...
:LAST_MODIFIED: [2026-02-06 Fri 20:54]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:END:
#+begin_src emacs-lisp :tangle no
...
:LAST_MODIFIED: [2026-03-11 Wed 04:13]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:END:
...
:LAST_MODIFIED: [2026-02-12 Thu 18:42]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:END:
...
:LAST_MODIFIED: [2026-02-06 Fri 20:55]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:END:
#+begin_src emacs-lisp :tangle no
...
:PROPERTIES:
:LAST_MODIFIED: [2026-03-23 Mon 15:33]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:CUSTOM_ID: fix-pdf-tools-post-build-command
:END:
~Figure out why the post-build command stopped working. Needed to delete the package, reinstall it, and manually run pdf-tools-install~
https://github.com/progfolio/elpaca/releases/tag/v0.1.0
TODO: replace deprecated =:post-build= command with =:build= but first check if it's necessary
...
:LAST_MODIFIED: [2026-04-19 Sun 14:51]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:END:
...
:LAST_MODIFIED: [2026-04-19 Sun 14:56]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
:END:
...
:PROPERTIES:
:LAST_MODIFIED: [2026-05-30 Sat 08:01]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.60
...
:PROPERTIES:
:LAST_MODIFIED: [2026-03-23 Mon 20:13]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50
...
#+end_src
*** Write browser text from Emacs
:PROPERTIES:
:LAST_MODIFIED: [2026-05-18 Mon 05:15]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.60
:CUSTOM_ID: write-browser-text-from-emacs
:END:
