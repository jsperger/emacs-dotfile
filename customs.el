...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :extend nil :stipple nil :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight medium :height 105 :width normal :foundry "JB" :family "JetBrains Mono NL")))))

;; (when (daemonp)
;;   (exec-path-from-shell-initialize))
(load-theme 'doom-nord)
(unless (face-attribute 'default :font)
  (setup-font))
