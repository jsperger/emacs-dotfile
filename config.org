...
* Overview
:PROPERTIES:
:TOC:      :include siblings :force (nothing) :ignore (nothing) :local (nothing) :depth 1
:CUSTOM_ID: overview
:LAST_MODIFIED: [2025-07-15 Tue 18:36]
...
:LAST_MODIFIED: [2025-07-15 Tue 19:33]
...
** setup-completion-display.el
:PROPERTIES:
:CUSTOM_ID: setup-completion-displayel
:END:
...
:END:
:PROPERTIES:
:LAST_MODIFIED: [2025-07-15 Tue 18:34]
:MODIFIED_WITH_EMACS: GNU Emacs 31.0.50 (build 1, aarch64-apple-darwin24.5.0, NS appkit-2575.60 Version 15.5 (Build 24F74))
of 2025-07-06
:END:
