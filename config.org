...
* Config directory
** my-keybinds.el
#+begin_src emacs-lisp :tangle config/my-keybinds.el
;;; my-keybinds.el --- general key binds -*- lexical-binding: t; -*-
;;; Commentary:
;;; Code:
...
** setup-casual.el
#+begin_src emacs-lisp :tangle config/setup-casual.el
...
* Lisp
** my-bib-helpers.el
#+begin_src emacs-lisp :tangle lisp/my-bib-helpers.el
...
** my-completion-helpers.el
#+begin_src emacs-lisp :tangle lisp/my-completion-helpers.el
...
** my-consult-helpers.el
#+begin_src emacs-lisp :tangle lisp/my-consult-helpers.el
...
** my-emacs-helpers.el
#+begin_src emacs-lisp :tangle lisp/my-emacs-helpers.el
...
** my-evil-helpers.el
#+begin_src emacs-lisp :tangle lisp/my-evil-helpers.el
...
** my-kbd-macros.el
#+begin_src emacs-lisp :tangle lisp/my-kbd-macros.el
...
** my-keybindings.el
#+begin_src emacs-lisp :tangle lisp/my-keybindings.el
...
** my-project-helpers.el
#+begin_src emacs-lisp :tangle lisp/my-project-helpers.el
...
** my-tempel-helpers.el
#+begin_src emacs-lisp :tangle lisp/my-tempel-helpers.el
...
** my-writing-helpers.el
#+begin_src emacs-lisp :tangle lisp/my-writing-helpers.el
