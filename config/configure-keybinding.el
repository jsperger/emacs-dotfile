...
;; [[file:../its-lit.org::#keyboard-macros][Keyboard macros:1]]
;;;; =========================== Keyboard macros ==========================
...
;; [[file:../its-lit.org::#global-key-binds][Global key binds:1]]
;;;; ========================== General Keybinds ==========================
(tyrant-def
...
(general-def
  ...
  "M-k" (defun scroll-other-window-previous-line (&optional arg)
          (interactive "P")
          (scroll-other-window (- (or arg 1)))))
;; Global key binds:1 ends here

;; [[file:../its-lit.org::ellama keybindings][ellama keybindings]]
;;================================== Ellama ================================
...
;; ellama keybindings ends here

;; [[file:../its-lit.org::eglot bindings][eglot bindings]]
;;================================== eglot =================================
...
;; Mac-specific keybinds:1 ends here
